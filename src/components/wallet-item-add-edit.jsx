                    ...
                    <div style={styles.field}>
                        ...
                        <div style={styles.field.rightCol}>
                            <TextField
                                ...
                                floatingLabelText={
                                    showFloatLabel ? 'username or email' : null
                                }
                    ...
                    <div style={styles.field}>
                        ...
                        <div style={styles.field.rightCol}>
                            <TextField
                                ...
                                type={
                                    showPasswordGenerator ? 'text' : 'password'
                                }
                                defaultValue={item && item.data.password}
                                floatingLabelText={
                                    showFloatLabel ? 'Pasword' : null
                                }
                            ...
                            {showPasswordGenerator ? (
                                <PasswordGenerator onSet={this.setPassword} />
                            ) : null}
                        </div>
                    </div>
                    ...
                    <div style={styles.field}>
                        ...
                        <div style={styles.field.rightCol}>
                            <TextField
                                ...
                                defaultValue={item && item.data.notes}
                                multiLine={true}
                                rows={4}
                                id="notes"
                                floatingLabelText={
                                    showFloatLabel ? 'Notes' : null
                                }
                                hintText="Notes"
                                hintStyle={{ top: '12px' }}
                            />
                ...
                <div style={styles.actionContainer}>
                    {isEdit ? (
                        <FlatButton
                            ...
                            icon={<DeleteIcon />}
                            primary={true}
                            onTouchTap={this.handleOnClickRemove}
                        />
                    ) : null}
                    ...
                    <div style={{ float: 'right' }}>
                        ...
                        <FlatButton
                            ...
                            onTouchTap={this.handleOnClickSave}
                        />
                    </div>
                </div>
            </div>
